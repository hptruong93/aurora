...
class SlicePlugin():
    ...
    def __init__(self, tenant_id, user_id, tag=None):
        ...
        self.plugins = {'VirtualInterfaces':'plugins.VirtualInterfaceManager.VirtualInterfaceManager', 'VirtualBridges':'plugins.VirtualBridgeManager.VirtualBridgeManager'}
